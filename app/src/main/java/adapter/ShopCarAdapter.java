...
public class ShopCarAdapter extends RecyclerView.Adapter<ShopCarAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_goods_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
       ...
       holder.mProducePrice.setText("￥"+mList.get(position).getPrice()+"");
        ...
        holder.mChildCb.setChecked(mList.get(position).isItem_check());
        holder.mChildCb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mList.get(position).setItem_check(holder.mChildCb.isChecked());
       ...
       holder.mRemoveView.setOnNumberChangeListener(new MyAddSubView.OnNumberChangeListener() {
        ...
        holder.mChildCb.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final CheckBox mChildCb;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mChildCb = itemView.findViewById(R.id.child_cb);
