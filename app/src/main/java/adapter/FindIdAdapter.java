...
public class FindIdAdapter extends RecyclerView.Adapter<FindIdAdapter.ViewHolder> {
    private List<FindIdBean.ResultBean> mData;
    private Context context;
    public FindIdAdapter(Context context){
        this.context=context;
        mData=new ArrayList<>();
    }
    public void setmData(List<FindIdBean.ResultBean> datas) {
        mData.clear();
        if (datas!=null){
            mData.addAll(datas);
        }
    ...
    @NonNull
    @Override
    public FindIdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(context).inflate(R.layout.find_id_layout,parent,false);
        FindIdAdapter.ViewHolder holder=new FindIdAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull FindIdAdapter.ViewHolder viewHolder, final int position) {
        FindIdAdapter.ViewHolder holder=viewHolder;
